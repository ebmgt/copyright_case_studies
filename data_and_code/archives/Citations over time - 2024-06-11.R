...
topic <- 'MBI'
#topic <- 'PHQ-9'
destination <- "Other" # "Other" "Journal" 
...
if (topic == 'PHQ-9'){
  ...
  filename <- "PubMed_Timeline_Results_by_Year - ‘PHQ-9’[tiab] - 'depressive disorder'[tiab] - medline - FINAL - 2024-06-11.csv"
...
text(x = min(data.medline$Year), 
     ...
     labels = paste0(
       ...
       #"\u2022 P (ANOVA compared to one less knot): ", round(best_model_p_value_0_knots,3), "\n",
       "\u2022 P (nonlinearity): ", best_model_row$P_value_compared_to_0_knots, "\n",
